 ...
 */
int strlist_add(StringList *strlist, char *str)
{
    int len = strlen(str);
    strlist->size++;
 ...
 */
int strlist_insertAfter(StringList *strlist, char* str, unsigned int index)
{
    int i, len;
 ...
 */
int strlist_removeLast(StringList *strlist){
    if(strlist->size <=0){
        return -1;
    }
 ...
 * 删除字符串列表index位置处的字符串
 */
int strlist_removeAt(StringList *strlist, unsigned int index)
{
    int i;
    if(index >= strlist->size){
        return -1;
 ...
 */
char* strlist_getStrAt(StringList *strlist, unsigned int index)
{
 ...
 */
int strlist_contains(StringList *strlist, char* str)
{
    int i;
 ...
 * 释放字符串列表占用的内存空间
 */
int strlist_free(StringList *strlist)
{
    int i;
    if(!strlist){
        return -1;
 ...
 * 打印字符串列表的相关信息
 */
void strlist_infolog(StringList *strlist)
{
    int i;
    printf("\n>>>\n");
    printf("strlist info:\n");
